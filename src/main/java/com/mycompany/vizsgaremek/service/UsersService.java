...
public JSONObject login(String email, String password) {
    ...
    try {
        ...
        // BCrypt ellenőrzés (regisztrációnál már így mented)
    ...
    try {
        ...
        if (newPassword != null && !newPassword.trim().isEmpty()) {
            ...
            try {
                ...
                // Ha a SP nincs → logold, de ne bukjon el az egész művelet
                System.err.println("Jelszócsere SP hiba: " + pwEx.getMessage());
                // Ha akarod, itt merge-elheted közvetlenül: user.setPassword(hashed); em.merge(user);
            }
        }
